...
content = """import logoUrl from '../assets/methodist-logo.png';
...
os.makedirs(r'd:\MY_SITES\Chruch_web\src\utils', exist_ok=True)
with open(r'd:\MY_SITES\Chruch_web\src\utils\canvasRenderer.js', 'w', encoding='utf-8') as f:
    f.write(content)

print("Created canvasRenderer.js")
