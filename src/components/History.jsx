    ...
    <section id="history" className="bg-cream overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="pt-16 lg:pt-24">
          <h2 className="text-primary text-3xl font-bold mb-6 lg:mb-8">
            {t("history.title")}
          </h2>
        </div>
        ...
        <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-12 lg:gap-16 xl:gap-24 items-start mt-8 lg:mt-10">
          <div className="order-1">
            <div className="max-w-2xl lg:pr-8">
              <p className="text-primary text-base md:text-lg leading-8 md:leading-9">
                {t("history.paragraph1")}
              </p>

              <p className="mt-5 text-primary text-base md:text-lg leading-8 md:leading-9">
