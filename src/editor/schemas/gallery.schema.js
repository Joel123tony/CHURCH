export default {
  ...
  styles: [
    ...
    { name: "cardTitleColor", label: "Card Title Color", type: "color", default: "#F4EFE7", group: "Typography" },
    ...
    { name: "metadataColor", label: "Metadata Color", type: "color", default: "#F4EFE7", group: "Typography" },
    ...
    { name: "buttonBackground", label: "Download Button Background Color", type: "color", default: "#FFFFFF", group: "Buttons" },
    { name: "buttonTextColor", label: "Download Button Text Color", type: "color", default: "#1E293B", group: "Buttons" }
  ]
};
